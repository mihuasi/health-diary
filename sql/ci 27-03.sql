...
-- Dumping data for table code_igniter.health_aspect_values: ~8 rows (approximately)
...
-- Dumping data for table code_igniter.influence_values: ~21 rows (approximately)
...
REPLACE INTO `influence_values` (`id`, `influence_id`, `date`, `value`, `comment`) VALUES
	...
	(29, 1, '2014-03-22', NULL, 'sausage|eggs'),
	(30, 2, '2014-03-22', NULL, 'panini'),
	(31, 3, '2014-03-22', NULL, 'fish'),
	...
	(53, 1, '2014-03-27', NULL, 'tea|porridge');
